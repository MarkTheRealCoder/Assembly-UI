...
from source.interface.debugger_old.memorydisplay.SegmentLabel import SegmentLabel
from source.interface.debugger_old.memorydisplay.SegmentScroll import SegmentScroll
