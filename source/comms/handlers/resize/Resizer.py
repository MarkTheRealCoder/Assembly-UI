...
from source.comms.events import ResizeEvent
from source.comms.handlers import EventRegister
from source.comms.handlers.resize.Controller import Controller
...
class Resizer(QObject):
    ...
    def eventFilter(self, obj, event: QEvent):
        if event == CursorChangeEvent:
            ...
            print(f"Resizing {self.___subset} in direction {direction} at position {current_pos}")
